          ...
          (o.prototype = {
            ...
            (o.prototype.setValues = function (t, e) {
              ...
              for (n = 0; n < t.length; n++)
                (d = Math.max(0, Math.min(r[t][n], a[t][n]))),
                  (a[t][n] = Math.round(d));
        ...
        function (e, n, i) {
          !(function (e, a) {
            ...
            function J(t) {
              ...
              return function (e) {
                var a,
                  o = "";
                for (a = 0; n > a; a++)
                  o += i[a] instanceof Function ? i[a].call(e, t) : i[a];
                return o;
              };
            }
            function X(t, e) {
            ...
            function K(t, e) {
              ...
              var i = 5;
              for (Ii.lastIndex = 0; i >= 0 && Ii.test(t); )
                (t = t.replace(Ii, n)), (Ii.lastIndex = 0), (i -= 1);
              return t;
            }
            function Q(t, e, n) {
              Ki[t] = D(e)
            ...
            function mt() {
              ...
              for (i.sort(t), a.sort(t), o.sort(t), e = 0; 12 > e; e++)
            ...
            function Et() {
              ...
              for (e = 0; 7 > e; e++)
                (n = c([2e3, 1]).day(e)),
                  ...
                  d.push(o);
              for (
                r.sort(t), s.sort(t), l.sort(t), d.sort(t), e = 0;
                7 > e;
                e++
              )
            ...
            function $t(t, e) {
              var n;
              return (
                t && ((n = p(e) ? ne(t) : te(t, e)), n && (ka = n)), ka._abbr
              );
            }
            function te(t, e) {
              if (null !== e) {
            ...
            function ce(e) {
              ...
              var n,
                ...
                d = 0;
              for (
                a = K(e._f, e._locale).match(Fi) || [], n = 0;
                n < a.length;
                n++
              )
                (o = a[n]),
            ...
            function Ze(e, n) {
              ...
              return this.format(
                r || this.localeData().calendar(o, this, ye(i))
              );
            }
            function Je() {
              return new b(this);
            ...
            var la = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
              da = "January_February_March_April_May_June_July_August_September_October_November_December".split(
                "_"
              ),
                    ...
                    return n.labels.length && n.datasets.length
                      ? n.labels.map(function (i, a) {
                          var o = t.getDatasetMeta(0),
                            ...
                            h = l.borderColor
                              ? l.borderColor
                              : d(r.borderColor, a, u.borderColor),
                            f = l.borderWidth
                              ? l.borderWidth
                              : d(r.borderWidth, a, u.borderWidth);
                          return {
                            text: i,
                            fillStyle: c,
                            strokeStyle: h,
              ...
              (t.controllers.line = t.DatasetController.extend({
                ...
                updateElement: function (t, e, i) {
                  var a,
                    ...
                    p =
                      1 === m.length || 1 === d.data.length || r.chart.isCombo;
                  void 0 !== d.radius &&
              ...
              (t.controllers.polarArea = t.DatasetController.extend({
                ...
                updateElement: function (t, n, i) {
                  ...
                  var b = s.startAngle,
                    y = t.hidden
                      ? 0
                      : d.getDistanceFromCenterForValue(r.data[n]),
                    x = b + h * m,
                    k = x + (t.hidden ? 0 : h),
                    S = l.animateScale
                      ? 0
            ...
            (t.defaults.radar = {
              ...
              (t.controllers.radar = t.DatasetController.extend({
                ...
                removeHoverStyle: function (t) {
                  ...
                  (o.radius = i.radius
                    ? i.radius
                    : e.getValueAtIndexOrDefault(n.radius, a, r.radius)),
                ...
                eventHandler: function (t) {
                  ...
                  return (
                    ...
                    ("mouseup" === t.type || "click" === t.type) &&
                      a.onClick &&
                      a.onClick.call(n, t, n.active),
                    n.lastActive.length &&
                      n.updateHoverStyle(n.lastActive, o.mode, !1),
                    n.active.length &&
                      o.mode &&
                      n.updateHoverStyle(n.active, o.mode, !0),
                    (r.enabled || r.custom) &&
                      (i.initialize(),
                ...
                removeHoverStyle: function (t, n) {
                  ...
                  (s.backgroundColor = o.backgroundColor
                    ...
                    (s.borderColor = o.borderColor
                      ? o.borderColor
                      : r(i.borderColor, a, n.borderColor)),
                    (s.borderWidth = o.borderWidth
                      ? o.borderWidth
                      : r(i.borderWidth, a, n.borderWidth));
                },
                setHoverStyle: function (t) {
                  var n = this.chart.data.datasets[t._datasetIndex],
                    i = t._index,
        ...
        function (t, e, n) {
          ...
          e.exports = function (t) {
            ...
            function a(t, i, a) {
              ...
              return d || u
                ? Math.min(d ? e(s, t, a) : c, u ? e(l, r, a) : c)
                : "none";
            }
            var o = (t.helpers = {});
            ...
            (o.requestAnimFrame = (function () {
              ...
              (o.getRelativePosition = function (t, e) {
                ...
                return (
                  (n = Math.round(
                    (((n - s.left - d) / f) * r.width) /
                      e.currentDevicePixelRatio
                  )),
                  (i = Math.round(
                    (((i - s.top - u) / g) * r.height) /
                      e.currentDevicePixelRatio
                  )),
                  { x: n, y: i }
                );
              ...
              update: function (t, n, i) {
                function a(t) {
                  var e,
                    n = t.isHorizontal();
                  n
                    ? ((e = t.update(t.options.fullWidth ? m : k, x)),
                      (S -= e.height))
              ...
              (t.Scale = t.Element.extend({
                ...
                fit: function () {
                  ...
                  if (
                    ...
                    u
                      ? (i.height = d && l.drawTicks ? p : 0)
                      : (i.height = n.maxHeight),
                    s.display &&
                      d &&
                      (u ? (i.height += 1.5 * m) : (i.width += 1.5 * m)),
                    r.display && d)
                  ) {
                    n.longestTextCache || (n.longestTextCache = {});
                    var v = e.longestText(
                    ...
                    if (u) {
                      ...
                      var k = n.ctx.measureText(n.ticks[0]).width,
                        S = n.ctx.measureText(n.ticks[n.ticks.length - 1])
                          .width,
                      ...
                      (n.paddingLeft =
                        ...
                        (n.paddingRight =
                          0 !== n.labelRotation ? _ * (c / 2) + 3 : S / 2 + 3);
                    } else {
                  ...
                  if (a.display) {
                    ...
                    if (g) {
                      if (
                        ((o = !1),
                        h && (F /= 2),
                        (F + d.autoSkipPadding) * i.ticks.length >
                    ...
                    if (u.drawBorder) {
                      ...
                      g
                        ? ((N = E = "top" === a.position ? i.bottom : i.top),
                          (N += U),
                          (E += U))
                        : ((z = H = "left" === a.position ? i.right : i.left),
                          (z += U),
                          (H += U)),
                        s.beginPath(),
                        s.moveTo(z, N),
          ...
          e.exports = function (t) {
            ...
            (t.Title = t.Element.extend({
              ...
              fit: function () {
                ...
                n.isHorizontal()
                  ? ((l.width = n.maxWidth),
                    (l.height = r ? s + 2 * a.padding : 0))
                  : ((l.width = r ? s + 2 * a.padding : 0),
              ...
              (t.Tooltip = t.Element.extend({
                ...
                update: function (t) {
                  ...
                  if (d.length) {
                    ...
                    r.determineAlignment(m),
                      a.extend(l, r.getBackgroundPoint(l, m));
                  ...
                  return (
                    a.isHorizontal()
                      ? ((i = a.width - (a.paddingLeft + a.paddingRight)),
                        (n =
                          a.start *
                          Math.pow(10, ((t - a.left - a.paddingLeft) * o) / i)))
                      : ((i = a.height - (a.paddingTop + a.paddingBottom)),
                        (n =
                          Math.pow(
                            10,
                            ((a.bottom - a.paddingBottom - t) * o) / i
                          ) / a.start)),
                    n
                  );
                },
